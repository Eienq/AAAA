...
if(!message.member.hasPermission("ADMINISTRATOR")) return message.reply(`Bu Komutu Kullanabilmek İçin Gerekli Yetkiye Sahip Değilsin!`)

  let uye = message.mentions.users.first() || message.author;
let bilgi = db.get(`yetkili.${uye.id}.toplam`);
let yazı = "Top Kayıt Listesi"
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ["topstats", "top-istatistik", "topistatistik", "top-kayıt"],
    permLevel: 0
};
